...
function payPanelToday() {
  return `<section class="panel" aria-labelledby="payTitle"><h2 class="annot" id="payTitle">Paywall <span class="dot">·</span> the toll</h2><p style="color:var(--ink-dim);font-size:14.5px;margin-bottom:16px">Sign in first, then subscribe. One plan, whole sky.</p><button class="btn solid" id="payBtn">Start at $42/month</button><p class="note">stripe price: price_1Ts6ceGzXpChNrVvnNrQ44Ms</p></section>`;
}
